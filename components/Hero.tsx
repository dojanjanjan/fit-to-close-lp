export default function Hero() {
  return (
    <header className="h-screen flex flex-col justify-center relative w-full">
      ...
      <div className="relative z-20 max-w-[1200px] mx-auto px-8 w-full text-center">
        <div className="inline-block bg-accent text-bg px-3 py-1 font-bold w-fit text-sm mb-4 relative z-30 mx-auto">
          BANGKOK 2026
        </div>
        ...
        <div className="flex flex-col gap-4 max-w-[600px] relative z-30 mx-auto">
